...
public class GuiGrinder extends GuiContainer {
    ...
    private static final ResourceLocation BG_TEXTURE = new ResourceLocation(Nurma.modId, "textures/gui/grinder.png");

    public GuiGrinder(Container container, InventoryPlayer playerInv) {
        super(container);
